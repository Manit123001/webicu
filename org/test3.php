...
// Select all the rows in the markers table
 $query = "select acidents.*,members.* from acidents LEFT JOIN members ON acidents.members_member_id = members.member_id WHERE acidents.types_type_id=2  ORDER BY ac_id DESC";
