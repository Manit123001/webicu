...
<!DOCTYPE html >
  ...
  <div style="height: 17%; " align="center">
    <h1 style="color: white">ICAREU แจ้งเหตุฉุกเฉิน</h1>
    <a href="mainshow0.php">แจ้งเหตุทั้งหมด</a> |
    <a href="mainshow1.php">แจ้งอุบัติเหตุ</a> | 
    <a href="mainshow2.php">แจ้งไฟใหม้</a> | 
    <a href="mainshow3.php">แจ้งจี้ ปล้น ลักทรัพย์</a> | 
    <a href="mainshow4.php">แจ้งทำร้ายร่างกาย</a>
    <br><br>
...
var markerA= [];
       ...
       var infoWindow;
          ...
          downloadUrl('http://icareuserver.comscisau.com/org/test3.php', function(data) {
            ...
            Array.prototype.forEach.call(markers, function(markerElem) {
              ...
              var iconBase;              
              if(type ==1){
                iconBase = 'http://icareuserver.comscisau.com/org/marker/a11.png';
              }else if(type == 2){
                iconBase = 'http://icareuserver.comscisau.com/org/marker/a22.png';
              }else if(type == 3){
                iconBase = 'http://icareuserver.comscisau.com/org/marker/a33.png';
              }else{
                iconBase = 'http://icareuserver.comscisau.com/org/marker/a44.png';
              }
